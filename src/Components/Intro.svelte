...
<section>
  <p class="body-text">
    This interactive website aims to explore whether the featured artists that Spotify promotes could
  ...
  <p class="body-text">For this exploration, we will do it in two parts. First, we will look into the
